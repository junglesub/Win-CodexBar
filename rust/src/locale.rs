...
locale_keys! {
    ...
    DetailPaceElapsed,
    DetailPaceResetRemaining,
    DetailPaceRestToTrack,
    DetailCostTitle,
    ApiSpendTitle,
    DetailCostUsed,
    DetailCostLimit,
    ...
    FloatBarBatteryStyleLabel,
    FloatBarBatteryStyleHelper,
    FloatBarBatterySlotsLabel,
    ...
    FloatBarPaceTimeDeltaLabel,
    FloatBarPaceTimeDeltaHelper,
